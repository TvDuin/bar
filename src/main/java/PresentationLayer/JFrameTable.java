...
public class JFrameTable extends javax.swing.JFrame {
    ...
    /* public void loadTableInfo() {
    		DefaultTableModel modelDranken = (DefaultTableModel) jTable3.getModel();
                
		for (Order t : this.manager.returnReceipt()) {
			modelDranken.addRow(new Object[]{ t });
		}
    } */
    ...
    private void initComponents() {
        ...
        if (jTable3.getColumnModel().getColumnCount() > 0) {
            ...
            jTable3.getColumnModel().getColumn(1).setPreferredWidth(850);
        }

        jButton1.setText("Bestellingen");
